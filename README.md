...
- Usage of Enum classes to process individual conditions and provide the user with several running modes (i.e. mixed or hard mode as a difficulty and types of math operations to be involved.)
